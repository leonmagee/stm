        ...
        <div class="field">
          ...
          <div class="select">
            <select name="current_month">
              ...
              <option value="{{ ($key + 1) }}" @if (($key + 1)==$current_month) selected="selected" @endif>{{ $month }}
              </option>
              @endforeach
            </select>
          </div>
    ...
    <form method="POST" action="/mode">
      ...
      <div class="form-wrap">
        ...
        <div class="field">
          ...
          <div class="select">
            <select name="mode">
              <option value="online" @if ('online'==$mode) selected="selected" @endif>Online</option>
              <option value="locked" @if ('locked'==$mode) selected="selected" @endif>Locked</option>
            </select>
          </div>
        </div>
        ...
        <div class="field">
          ...
          <div class="select">
            <select name="site">
              ...
              <option value="{{ $site->id }}" @if ($site->id == $current_site)
                selected="selected"
                @endif
                >{{ $site->name }}</option>
              @endforeach
