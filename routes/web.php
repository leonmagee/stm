...
Route::get('dealer-imeis', 'ImeiSearchController@index_dealers');
...
Route::group(['middleware' => 'App\Http\Middleware\LockOutUsersManagers'], function () {
    ...
    Route::get('delete-promotion/{promotion}', 'PromotionController@destroy');
    Route::get('coupons', 'CouponController@index');
    Route::post('add-coupon', 'CouponController@store');
    Route::post('start-promotion/{coupon}', 'CouponController@start_promotion');
    Route::post('end-promotion/{coupon}', 'CouponController@end_promotion');
    ...
    Route::post('slider-update-order', 'HomeController@update_order');
});
...
Route::get('/api/v1/imei_search_agent', 'APIController@getImeiRecordsAgent')->name('api.imei_search.index-agent');
...
Route::get('dealer-4th-recharge', 'ReportsController@dealer_4th_recharge');
Route::get('recharge-data', 'ReportsController@recharge');
Route::get('3rd-recharge-data', 'ReportsController@third_recharge');
Route::get('4th-recharge-data', 'ReportsController@fourth_recharge');
